'''
DL Model's Operator In Tensorflow Template
...
def FC_(input, units, name):
    with tf.variable_scope(name):
        return tf.layers.dense(
            input, units, activation=None, use_bias=True, kernel_initializer=None,
...
def GAP_(input, keepdims):
    return tf.reduce_mean(input, axis=(1, 2), keepdims=keepdims)
